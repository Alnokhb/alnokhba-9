...
(function ($) {
  ...
  */
  ...
  // const words = ['أخبار الانتخابات','معلومات قائمة النخبة'];
...
// });
  ...
  --------------------------------------------------------------*/
  function preloader() {
    // إخفاء المحتويات الداخلية لشاشة التحميل مع تأثير fadeOut لمدة 1500 ملي ثانية
    $('.cs-preloader_in').fadeOut(500);
    // بعد تأخير 1500 ملي ثانية، إخفاء شاشة التحميل الرئيسية بتأثير fadeOut لمدة 1500 ملي ثانية
    $('.cs-preloader').delay(500).fadeOut(500);
  }
